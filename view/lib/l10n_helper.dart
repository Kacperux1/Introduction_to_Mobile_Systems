...
class S {
  ...
  static const _translations = {
    'en': {
      ...
      'purchase_success': 'Purchase request sent! The seller must now confirm the transaction.',
      ...
      'login_required_buy': 'You must be logged in to buy a book.',
      ...
      'sale_confirmed': 'Sale confirmed successfully!',
      'confirm_failed': 'Failed to confirm sale: {error}',
    ...
    'pl': {
      ...
      'purchase_success': 'Zgłoszono chęć zakupu! Sprzedawca musi teraz potwierdzić transakcję.',
      'purchase_failed': 'Zakup nieudany: {error}',
      ...
      'login_required_buy': 'Musisz być zalogowany, aby kupić książkę.',
      'history_title': 'Historia transakcji',
      'purchases': 'Zakupy',
      'sales': 'Historia sprzedaży',
      'pending_sales': 'Oczekujące sprzedaże',
      'no_history': 'Brak historii transakcji.',
      'date': 'Data',
      'seller': 'Sprzedawca',
      'buyer': 'Kupujący',
      'confirm_sale': 'Potwierdź sprzedaż',
      'sale_confirmed': 'Sprzedaż potwierdzona pomyślnie!',
      'confirm_failed': 'Nie udało się potwierdzić sprzedaży: {error}',
      // Accessibility strings
      'selected': 'wybrany',
